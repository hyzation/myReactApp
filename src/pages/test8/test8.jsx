...
import { useGLTF, ContactShadows, OrbitControls, PerspectiveCamera, AccumulativeShadows, RandomizedLight, PointerLockControls, Environment, useTexture, OrthographicCamera, useAnimations, Grid, Stage, Loader } from "@react-three/drei";
        ...
        <>
            <Suspense fallback={<Loader />}>
                ...
                <Canvas className="canvas" style={{ 'height': '100vh', }}
                    shadows
                    onMouseDown={() => { state.canLerp = false }}
                    onTouchMove={() => { state.canLerp = false }}
                >
