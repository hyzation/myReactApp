...
import { Grid, Environment, CameraControls, PerspectiveCamera, useHelper, Stats, useGLTF, FaceLandmarker, FaceControls, } from '@react-three/drei'
...
import NewSky from '../test5/NewSky'
...
export default function App() {
    return (
        <>
            <Canvas shadows camera={{ position: [-0.6, 0.1, 0.6], near: 0.01 }} style={{ 'height': '100vh', }}>
                <FaceLandmarker>
                    <Scene />
                </FaceLandmarker>
            </Canvas>
